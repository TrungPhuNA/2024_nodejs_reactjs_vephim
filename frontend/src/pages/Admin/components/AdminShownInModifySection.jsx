        ...
        <section className="section-admin-movie-modify">
            <div className="section-movie-playlist container">
                <div className="form-heading-container">
                    <h2 className="form-admin-heading playlist">Cập nhật danh sách phát phim</h2>
                ...
                {moviePlaylistDropDown && (
                    <form className="form-admin-showtime-add">
                        ...
                        {selectedShowDate.length > 0 && (
                            <>
                                <h3 className="admin-heading-secondary">Chọn</h3>
                                <div className="form-admin-radio-options">
                                    {latestShowtimesHtml}
                                </div>
                            </>
                        ...
                        {selectedShowtime !== "" && (
                            <>
                                <h3 className="admin-heading-secondary">Thay đổi</h3>
                                <div className="form-admin-radio-options">
                                    {replaceOptionsHtml}
                                </div>
                            </>
